...
//	@Disabled
    public void listAccounts() {
        ...
        Account[] accounts = restTemplate.getForObject("http://localhost:8080/accounts", Account[].class); // Modify this line to use the restTemplate
...
//	@Disabled
    public void getAccount() {
        ...
        // - Run the test and ensure that it passes.
        Account account = restTemplate.getForObject("http://localhost:8080/accounts/0", Account.class); // Modify this line to use the restTemplate
...
//	@Disabled
    public void createAccount() {
        ...
        Account account = new Account("123123", "John Doe");
        ...
        URI newAccountLocation = restTemplate.postForLocation(  "http://localhost:8080/accounts", account); // Modify this line to use the restTemplate
